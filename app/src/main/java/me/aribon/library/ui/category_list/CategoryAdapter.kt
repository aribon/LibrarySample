...
import me.aribon.library.ui.category_list.CategoryAdapter.CategoryViewHolder
...
class CategoryAdapter(
  ...
  override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
    ...
    holder.itemView.tvCategoryItemBooksAvailable.text = String.format(
        context.getString(R.string.tui_category_item_books_available, viewModel.booksAvailable))
